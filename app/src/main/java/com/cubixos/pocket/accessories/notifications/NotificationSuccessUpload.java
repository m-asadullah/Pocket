...
public class NotificationSuccessUpload {

    //Notification - Account Image
    public static void notificationFileUpload(Activity activity, Context context, String title, String description, String stringFilename, String stringFileSize){
        String id = "id_file_upload" ;
        String stringTitle = "File Upload" + title;
        String stringDescription = stringFilename + " of " + stringFileSize +" uploaded successfully." ;
