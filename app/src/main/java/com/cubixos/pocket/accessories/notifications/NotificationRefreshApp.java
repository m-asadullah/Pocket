...
public class NotificationRefreshApp {

    //Notification - Refresh
    public static void showNotificationRefreshApp(Activity activity, Context context){
        String id = "id_settings_refresh" ;
        String title = "Refresh" ;
        String description = "App refresh successfully. Now enjoy on the go." ;
        ...
        managerCompat.notify(4003, builder.build());
    }
}
